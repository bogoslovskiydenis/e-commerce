...
let UsersController = class UsersController {
    ...
    async toggleActiveStatus(id, req) {
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('users.view'),
...
__decorate([
    (0, common_1.Get)('system/roles-and-permissions'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermissions)('users.view'),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermissions)('users.edit'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "toggleActiveStatus", null);
