...
async function seedProducts() {
    ...
    try {
        ...
        for (const productData of products) {
            ...
            // Трансформируем данные: image -> images, quantity -> stockQuantity, metadata -> attributes
            const { image, quantity, metadata, ...restData } = productData;
            const transformedData = {
                ...restData,
                slug: slug,
                images: productData.images || (image ? [image] : []),
