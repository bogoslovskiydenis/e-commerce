...
interface BalloonProductPageProps {
    params: Promise<{
        category: string;
        id: string;
    }>;
...
// Моковые данные товаров по категориям (воздушные шары)
const BALLOON_PRODUCTS_DATA: Record<string, Record<string, BalloonProductData>> = {
    hearts: {
        '1': {
            id: '1',
                ...
                <div className="container mx-auto px-4 py-3">
                    <nav className="text-sm">
                        <ol className="flex items-center space-x-2">
                            ...
                            <li className="text-gray-400">/</li>
                            <li><Link href={`/balloons/${category}`} className="text-gray-500 hover:text-teal-600">{product.category}</Link></li>
                            <li className="text-gray-400">/</li>
